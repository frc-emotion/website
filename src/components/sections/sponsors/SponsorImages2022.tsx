...
export default function SponsorImages2022() {
    ...
    const logoFolder = "https://cdn.jsdelivr.net/gh/frc-emotion/images@main/sponsors/2022"; // last character CANNOT be a '/'
    ...
    return (
        <div
            className="mx-[5vw] my-[60px] bg-teamYellow-500 p-8 rounded-xl"
            id="2023sponsors"
        >
