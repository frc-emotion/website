...
const privacyPolicy = `
# Privacy Policy for Nautilus Mobile App
**Last Updated:** December 14, 2024

## 1. Introduction
Welcome to the Nautilus mobile app by Team 2658! We are committed to protecting your privacy and ensuring that your personal information is handled safely and responsibly. This Privacy Policy outlines how we collect, use, store, and safeguard your information when you interact with the Nautilus mobile app. By using the Nautilus mobile app, you agree to the terms outlined in this policy.

## 2. Information We Collect

### 2.1 Personal Information
When you create or manage your account within the Nautilus mobile app, we collect the following personal information and may collect additional details as needed to provide and improve our services:
...
*Note:* We may collect additional personal information as necessary to deliver and enhance the Nautilus mobile app experience.

### 2.2 Non-Personal and Diagnostic/Telemetry Data
We collect non-personal information to help improve your experience and the performance of the Nautilus mobile app. This includes:
- **Telemetry Data:** We use Sentry to gather telemetry data such as usage statistics, error reports, and performance metrics. This data may include identifiable details (for example, IP addresses and incidental location information) used exclusively for monitoring, troubleshooting, and enhancing the Nautilus mobile app.
...
When you access the Nautilus mobile app, certain information is automatically collected, including:
...
### 2.4 Location Data
The Nautilus mobile app does **not** actively offload user location data. However, in cases where location data is incidentally captured as part of diagnostic or telemetry processes:
...
To continually enhance the Nautilus mobile app and address evolving needs, we reserve the right to collect further information beyond what is explicitly detailed in this Privacy Policy.
...
- **Provide and Maintain the Nautilus Mobile App:** Facilitate account creation, login, and management.
...
- **Sentry:** We use Sentry for telemetry and error tracking purposes. Sentry collects non-personal and diagnostic data, including identifiable details (such as location telemetry data that is not anonymized), solely to help us identify and resolve issues within the Nautilus mobile app. For more information, please review Sentry’s Privacy Policy.
...
The Nautilus mobile app is intended for individuals aged 13 or older. We do not knowingly collect personal information from children under 13. If you become aware that a child under 13 has provided us with personal information without parental consent, please contact us immediately so we can take appropriate action.

## 10. Changes to This Privacy Policy
We may update this Privacy Policy periodically. Any changes will be posted on this page with an updated effective date. We encourage you to review this policy regularly to stay informed about how we are protecting your information in the Nautilus mobile app.
...
## 12. Consent
By using the Nautilus mobile app, you hereby consent to this Privacy Policy and agree to its terms.

## 13. Miscellaneous
- **International Transfers:** If you access the Nautilus mobile app from outside the United States, please be aware that your data may be transferred to and processed in the United States.
- **Third-Party Links:** The Nautilus mobile app may include links to third-party websites. We are not responsible for the privacy practices or content of these external sites.
- **Future Data Collection:** We reserve the right to adjust and expand the types of data we collect in order to enhance the Nautilus mobile app. Any additional data collected in the future will be processed in accordance with this Privacy Policy.
