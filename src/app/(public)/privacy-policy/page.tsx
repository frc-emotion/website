...
### 2.4 Location Data
Our app does **not** actively offload user location data. However, in cases where location data is incidentally captured as part of diagnostic or telemetry processes:
